var lunrIndex,$results,pagesIndex,tinySegmenter;function initLunr(){return tinySegmenter=new lunr.TinySegmenter,new Promise((t,n)=>{var e=new XMLHttpRequest;e.open("GET","index.json",!0),e.onload=function(){if(e.status>=200&&e.status<400)pagesIndex=JSON.parse(e.responseText),console.log("index:",pagesIndex),lunrIndex=lunr(function(){this.use(lunr.ja),this.field("title",{boost:10}),this.field("categories"),this.field("tags"),this.field("description"),this.ref("href");for(var e=0;e<pagesIndex.length;++e)this.add(pagesIndex[e]);t()});else{var s=textStatus+", "+error;console.error("Error getting Hugo index flie:",s),n(s)}},e.send()})}function initUI(){$results=document.getElementById("results"),$search=document.getElementById("search"),$search.onkeyup=function(){for(;$results.firstChild;)$results.removeChild($results.firstChild);var e=$search.value,e=decodeURI(e),t=search(e);renderResults(t)}}function search(e){var t=tinySegmenter.segment(e),t=t.map(function(e){return e=e.trim(),e.length&&(e=`+*${e}*`),e});return e=t.join(" ").replace(/\s+/g," ").trim(),console.log("search:",e),lunrIndex.search(e).map(function(e){return pagesIndex.filter(function(t){return t.href===e.ref})[0]})}function renderResults(e){if(!e.length)return;$results=document.getElementById("results"),e.slice(0,10).forEach(function(e){var t,o,n=document.createElement("div"),s="";e.categories&&(s=`
        ...
        `,$results.appendChild(n)})}initLunr().then(function(){var e=getQuery().query||"",e=decodeURI(e),t=search(e);renderResults(t),e.length&&(document.getElementById("list-title").innerText=`「${e}」を検索`)}),document.addEventListener("DOMContentLoaded",function(){});function getQuery(){var e=window.location.search,e=e.slice(1),t={};return e.split("&").forEach(function(n){const e=n.split("=");t[e[0]]=e[1]}),t}